...
* Update manpages, see [gen-manpages.sh](https://github.com/joebauers/litecoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/joebauers/litecoin.git
...
- Detached signatures will then be committed to the [litecoin-detached-sigs](https://github.com/joebauers/litecoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/joebauers/litecoin/releases/new) with a link to the archived release notes.
